<script>
  ...
  import Card, { ccvEnter, ccvLeave } from "./Card.svelte";
...
<form on:submit|preventDefault={handleSubmit}>
	...
	<div class="flexbox">
      ...
      {#each $month as item}				
		...
		<div class="inputBox">
			<span>ccv</span>
			<input bind:value={$ccv} type="text" maxlength="4" class="ccv-input" on:mouseenter={ccvEnter} on:mouseleave={ccvLeave} on:focus={()=>{$ccv = ""}}>
		</div>
	</div>
